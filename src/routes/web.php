...
Route::group(['prefix' => 'products'], function () {
	...
	Route::get('/export', [ProductController::class, 'exportList'])->name('products.exportList');
	...
	Route::get('/history/list', [ProductController::class, 'historyList'])->name('products.historyList');
});